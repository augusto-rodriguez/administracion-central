...
class EstadisticaController extends Controller
{
    public function index(Request $request)
    {
        ...
        // Capitán: compañía siempre fija a la suya, ignorando el request
        $companiaId = $esCapitan
            ? $companiaIdCapitan
            : ($request->compania_id ?? null);
        ...
        // Ranking por compañía: no aplica para capitán (solo ve la suya)
        $rankingPorCompania = collect();
        if (!$esCapitan) {
